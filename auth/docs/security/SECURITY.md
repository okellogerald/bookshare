...
>
> **Companion docs:**
> - [AUTH-SYSTEM.md](../flows/AUTH-SYSTEM.md) — High-level auth architecture
...
**File:** `auth/infra/kratos/kratos.yml`
...
**File:** `auth/infra/hydra/hydra.yml`
...
**OAuth client configuration** (`auth/infra/hydra/init-client.sh`):
...
**Layer 3 — Auth Portal logout** (`auth/web/src/app/logout/route.ts`):
...
| `auth/infra/kratos/kratos.yml` | Infrastructure | Kratos crypto, flows, allowed URLs |
| `auth/infra/hydra/hydra.yml` | Infrastructure | Hydra token strategy, cookies, subjects |
| `auth/infra/hydra/init-client.sh` | Infrastructure | OAuth client configuration |
