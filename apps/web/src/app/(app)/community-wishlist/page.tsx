...
export default function CommunityWishlistPage() {
  ...
  const [fulfillStatus, setFulfillStatus] = useState<"lent" | "gone">("lent");
          ...
          <div className="space-y-3 rounded-md border p-3">
            <div className="flex flex-wrap items-center gap-2">
              <p className="text-xs uppercase tracking-wide text-muted-foreground">
                Community wishers ({selectedWantFromFiltered.want_count})
              </p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 rounded border border-dashed p-2">
              ...
              {isAuthenticated ? (
                ...
                <Button type="button" asChild>
                  <Link href="/api/auth/login?returnTo=/community-wishlist">Sign In</Link>
                </Button>
              )}
            </div>
      ...
      <Dialog open={fulfillOpen} onOpenChange={setFulfillOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <Label>Status After Exchange</Label>
              <Select
                value={fulfillStatus}
                onValueChange={(value) =>
                  setFulfillStatus(value as "lent" | "gone")
                }
              >
                <SelectTrigger>
                  <SelectValue />
